...
*`mining.stat.miner.name`*::
+
--
Name of mining software
...
*`mining.stat.miner.version`*::
+
--
Version of mining software
...
*`mining.stat.miner.uptime`*::
+
--
Uptime of mining software
...
*`mining.stat.miner.pool`*::
+
--
Pool of mining software
...
*`mining.stat.miner.address`*::
+
--
User address of mining software
...
*`mining.stat.miner.algorithm`*::
+
--
Running algorithm of mining software
...
*`mining.stat.miner.worker`*::
+
--
Worker name of mining software
...
*`mining.stat.gpu.temperature.core`*::
+
--
Core chipset temperature
...
*`mining.stat.gpu.temperature.memory`*::
+
--
...
*`mining.stat.gpu.power`*::
+
--
GPU consumption power as wattage(W)
...
*`mining.stat.gpu.share.accepted`*::
+
--
...
*`mining.stat.gpu.share.rejected`*::
+
--
