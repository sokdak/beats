...
|<<metricbeat-module-mining,mining>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-mining-stat,stat>> beta[]  
...
include::modules/mining.asciidoc[]
